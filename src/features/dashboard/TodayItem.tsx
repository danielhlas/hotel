...
const StyledTodayItem = styled.li`
  ...
  grid-template-columns: 5.2rem 1fr 6rem;
  gap: 1.8rem;
  align-items: center;
  ...
  return (
    <div>
      <StyledTodayItem>
        ...
        <span className="hidden min-[599.9px]:inline-block">
          <Flag src={current.guests.countryFlag} />
        </span>

        <Guest>
          <span className="inline-block min-[599.9px]:hidden pr-2">
            <Flag src={current.guests.countryFlag} />
          </span>
          {current.guests.fullName}
        </Guest>
